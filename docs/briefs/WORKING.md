...
Install: `npm i -g cursor-route` → **0.1.16**. Release notes: [CHANGELOG.md](../../CHANGELOG.md).
...
| 2026-09-16 | Ship Zen strongest-free ranker → **0.1.16 LIVE** on npm. Ox Alpha is offline fallback only, not a live pin. Mid still `claude-ds`. |
